import { Business, Enterpreneurdata, Includedata } from "./common/Helper";
import { RedStar, WhiteTick } from "./common/Icon";
...
export const DiscountBtn = () => {
  return (
    <button className="py-[4px] px-[8px] bg-light-red text-dark-black-300 font-semibold text-xs rounded-3xl">
      -20%
    </button>
  );
};
